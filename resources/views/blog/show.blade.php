...
@section('header')
    ...
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{ asset('img/' . $post->image) }});"
        data-overlay="9">
    ...
    <main class="main-content">
        ...
        <div class="section" id="section-content">
            <div class="container">
                ...
                <div class="addthis_inline_share_toolbox_armo"></div>
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <script>
                            ...
                            (function() { // DON'T EDIT BELOW THIS LINE
                                ...
                                s.src = 'https://sass-blog-e0edikc8pp.disqus.com/embed.js';
